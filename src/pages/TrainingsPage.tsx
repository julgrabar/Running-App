...
export const WeekTrainingsPage= () => {
    ...
    const {data: week, isLoading, isSuccess, isError} = useQuery<IWeek, Error>(["week", weekId], ()=>fetchTrainings(weekId))

    const navigate = useNavigate()
    
    return <CenteringWrapper><TrainingsPageWrapper>
        ...
        <Button primary type="button" onClick={()=> navigate("/trainings")} style={{marginTop: "30px"}}>
            <span>Go back</span>
        </Button>
